        ...
        <table class="table table-dark table-striped">
            ...
            <c:forEach var="employee" items="${employeeList}">
                <tr>
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/employees?action=update&id=${employee.getId()}">
                            <i class="fa-solid fa-user-pen"></i>
                        </a>
                        <a href="${pageContext.request.contextPath}/employees?action=remove&id=${employee.getId()}">
